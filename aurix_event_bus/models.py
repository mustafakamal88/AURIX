...
class AurixEventType(str, Enum):
    ...
    STRATEGY_REGISTRY_LOADED = "strategy_registry_loaded"
    STRATEGY_EVALUATION_STARTED = "strategy_evaluation_started"
    STRATEGY_EVALUATION_COMPLETED = "strategy_evaluation_completed"
    STRATEGY_SIGNAL_REJECTED = "strategy_signal_rejected"
    STRATEGY_SIGNAL_CANDIDATE = "strategy_signal_candidate"
    STRATEGY_SIGNAL_ACTIONABLE = "strategy_signal_actionable"
    STRATEGY_PIPELINE_ERROR = "strategy_pipeline_error"
